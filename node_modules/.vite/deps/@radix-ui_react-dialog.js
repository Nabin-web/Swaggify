...
function createSlot2(ownerName) {
  ...
  const Slot22 = React17.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime5.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React17.isValidElement(newElement) ? React17.cloneElement(newElement, void 0, newChildren) : null });
    }
...
// node_modules/@radix-ui/react-portal/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/node_modules/@radix-ui/react-compose-refs/dist/index.mjs
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React23.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime8.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React23.isValidElement(newElement) ? React23.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable3(child) {
  return React23.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER3;
}
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React30.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime11.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React30.isValidElement(newElement) ? React30.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var RemoveScroll = React33.forwardRef(function(props, parentRef) {
  ...
  return React33.createElement(
    React33.Fragment,
    null,
    enabled && React33.createElement(SideCar, { sideCar: effectCar, removeScrollBar, shards, noRelative, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
function RemoveScrollSideCar(props) {
  ...
  return React34.createElement(
    React34.Fragment,
    null,
    inert ? React34.createElement(Style, { styles: generateStyle(id) }) : null,
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime13.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React36.Children.map(children, (child) => (0, import_jsx_runtime13.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime13.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
